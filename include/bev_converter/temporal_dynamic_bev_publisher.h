...
class TemporalDynamicBEV
{
	...
	private:
		...
		PointCloudIPtr pcl_import_dynamic_pointcloud {new PointCloudI};
		PointCloudIPtr pcl_current_all_pointcloud {new PointCloudI};
		...
		cv::Size image_size;
		cv::Mat format_image;
		std::vector<cv::Mat> dynamic_image_list;
